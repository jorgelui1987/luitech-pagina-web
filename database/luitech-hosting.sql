-- =====================================================================
--  LUITECH — Importación para HOSTING (BD ya creada: "paginaweb")
--  Este archivo NO crea ni selecciona base de datos (en hosting de pago
--  compartido no se permiten CREATE DATABASE / USE).
--
--  Cómo usarlo:
--   1. Abre phpMyAdmin del hosting y selecciona la base "paginaweb".
--   2. Pestaña "Importar" -> sube este archivo.
--  Se puede reejecutar sin duplicar datos (INSERT IGNORE).
-- =====================================================================

SET NAMES utf8mb4;

-- ---------------------------------------------------------------------
-- Usuarios administradores del panel (login con bcrypt de PHP)
...
INSERT IGNORE INTO usuarios_admin (usuario, password_hash, nombre)
